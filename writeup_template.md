...
To train the model, I used adam optimizer with  batch size 128, and no of epochs 50.
...
For the 4th image atleast the actual output is the 2nd highest probabilty prediction which is a good sign.
